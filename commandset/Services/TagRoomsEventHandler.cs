        ...
        public void Execute(UIApplication uiapp)
        {
            ...
            try
            {
                ...
                if (_roomIds != null && _roomIds.Count > 0)
                {
                    ...
                    var firstRoom = _doc.GetElement(RevitMCPCommandSet.Utils.ElementIdExtensions.ToElementId(_roomIds[0])) as Room;
                    if (firstRoom != null)
                    {
                ...
                if (_roomIds != null && _roomIds.Count > 0)
                {
                    ...
                    rooms = _roomIds
                        .Select(id => _doc.GetElement(RevitMCPCommandSet.Utils.ElementIdExtensions.ToElementId(id)))
